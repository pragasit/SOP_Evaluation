...
@RestController
@RequestMapping(value = "/Lecture Evaluation")
public class LectureEvaluation {
	...
	@GetMapping("/")
	public List<Student> Lecture_evaluation_results() {
	...
	@PostMapping("/")
	public ResponseEntity<Object> Lecture_evaluation(@RequestBody Student student) {
